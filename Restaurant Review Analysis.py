...
df=pd.read_csv(r'E:\python\dataset\sentiment\Restaurant_Reviews.txt',delimiter="\t")
...
lbl_title=Label(win,text="Restaurant Review Ananlysis",font=('',50,'bold'),bg='orange')
